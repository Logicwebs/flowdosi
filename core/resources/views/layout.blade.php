...
<div class="tradingview-widget-container">
  ...
  "symbols": [
    {
      "description": "ZAR/ZMW",
      "proName": "FX_IDC:ZARZMW"
    },
    {
      "description": "ZAR/TZS",
      "proName": "FX_IDC:ZARTZS"
    },
    {
      "description": "ZAR/NGN",
      "proName": "FX_IDC:ZARNGN"
    }
  ],
            ...
            <div class="navbar navbar-main navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand" href="{{url('/')}}">
                        <img alt="" title="" src="{{url('/')}}/asset/{{$logo->image_link}}" width="200px">
                    </a>
                    ...
                    <div class="collapse navbar-collapse navbar-collapse-overlay" id="navbar-main-collapse">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('blog')}}">{{__('Learn more')}}</a>
                            </li>                           
                        </ul>
                    </div>
                </div>
