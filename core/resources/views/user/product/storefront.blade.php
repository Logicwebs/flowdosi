                        ...
                        <div class="row">  
                            @if(count($store)>0)
                                @foreach($store as $k=>$val)
                                    <div class="col-md-4">
                                        <div style="background-image: url({{url('/')}}/asset/images/store_bg.png); background-size:cover;" class="card bg-white">
                                        <!-- Card body -->
                                        <div class="card-body">
                                            <div class="row mb-2">
                                            <div class="col-4">
                                            ...
                                            <div class="col">
                                                ...
                                                <p style="background:#4e7bee; border-radius:2px;">{{__('Category')}}: {{$val->category}}</p>
