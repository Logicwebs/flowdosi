...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    ...
    <div class="mb-3">
        <img src="{{url('/')}}/asset/images/logo-2.png" width="250px">
    </div>
    <div class="mb-9">
   
     <input type="text" name="amount" class="form-control" @if($ver->status==1 || $user->business_level==3) disabled @endif value="" placeholder="Amount you want deposit" id="2otherField">
   <hr>
     <button type="submit" class="btn btn-neutral btn-sm">{{__('Deposit')}}</button>
             
    </div>
    <div class="row">
        <div class="col-md-8"></div>
        <div class="col-md-4"><div class="mb-">
      Available <h1 style="font-size:15px" class="badge badge-success"> R250.00</h1>
    </div></div>
