...
<html class="no-js" lang="en">
  ...
  />
        ...
        <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital@1&family=Oswald:wght@200&family=Raleway:wght@100;200&display=swap" rel="stylesheet">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-3">   
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('user.mpesa.index')==url()->current()) active @endif" href="{{route('user.mpesa.index')}}">
                <i class="fad fa-mobile"></i>
                <span class="nav-link-text">{{__('Mpesa')}}</span>
              </a>
            </li>  
            <li class="nav-item">
              <a class="nav-link @if(route('user.mtn.index')==url()->current()) active @endif" href="{{route('user.mtn.index')}}">
                <i class="fad fa-sim-card"></i>
                <span class="nav-link-text">{{__('MTN | Pick n Pay | Nedbank | Checkers Mobile Money')}}</span>
              </a>
            </li> 
            <li class="nav-item">
              <a class="nav-link @if(route('user.nedbank.index')==url()->current()) active @endif" href="{{route('user.nedbank.index')}}">
                <i class="fad fa-wallet"></i>
                <span class="nav-link-text">{{__('NedBank Mobile')}}</span>
              </a>
            </li>            
            <li class="nav-item">
...
<!-- footer begin -->
  ...
  <script src="{{url('/')}}/asset/js/stitch.js"></script>
